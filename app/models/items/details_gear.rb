module GearDetails
	def acid
		{ :body => "As an action, you can splash the contents of this vial onto a creature within 5 feet of you or throw the vial up to 20 feet, shattering it on impact. In either case, make a ranged attack against a creature or object, treating the acid as an improvised weapon. On a hit, the target takes 2d6 acid damage."}
	end

	def alchenist_fire
		{ :body => "This sticky, adhesive fluid ignites when exposed to air. As an action, you can throw this flask up to 20 feet, shattering it on impact. Make a ranged attack against a creature or object, treating the alchemist’s fire as an improvised weapon. On a hit, the target takes 1d4 fire damage at the start of each of its turns. A creature can end this damage by using its action to make a DC 10 Dexterity check to extinguish the flames."}
	end

	def antitoxin
		{ :body => "A creature that drinks this vial of liquid gains advantage on saving throws against poison for 1 hour. It confers no benefit to undead or constructs."}
	end

 	def arcane_focus
		{ :body => "An arcane focus is a special item— an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item— designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus, as described in chapter 10."}
	end
	...
	def block_and_tackle
		{ :body => "A set of pulleys with a cable threaded through them and a hook to attach to objects, a block and tackle allows you to hoist up to four times the weight you can normally lift."}
	end

	def book
		{ :body => "A book might contain poetry, historical accounts, information pertaining to a particular field of lore, diagrams and notes on gnomish contraptions, or just about anything else that can be represented using text or pictures. A book of spells is a spellbook (described later in this section)."}
	end
	...
	def candle
		{ :body => "For 1 hour, a candle sheds bright light in a
...
to twenty crossbow bolts" }
	...
	def map_scroll_case
		{ :body => "This cylindrical leather case can
hold up to ten rolled-up sheets of paper or five rolled-up
sheets of parchment" }
	end

	def chain
		{ :body => "A chain has 10 hit points. It can be burst with a
successful DC 20 Strength check" }
	end

	def climber_kit
		{ :body => "A climber’s kit includes special pitons,
...
feet away from that point without undoing the anchor." }
	...
	def component_pouch
		{ :body => "A component pouch is a small,
...
can be applied." }
	...
	def druidic_focus
		{ :body => "A druidic focus might be a sprig of
...
and teeth from sacred animals. A druid (see chapter 3
of the Player’s Handbook) can use such an object as a
spellcasting focus, as described in chapter 10." }
	end

	def fishing_tackle
		{ :body => "This kit includes a wooden rod, silken
line, corkwood bobbers, steel hooks, lead sinkers, velvet
lures, and narrow netting" }
	end

	def healer_kit
		{ :body => "This kit is a leather pouch containing
...
box holding a fragment of a sacred relic. The Player’s
Handbook lists many gods in the multiverse and their
typical symbols. A cleric or paladin can use a holy
symbol as a spellcasting focus, as described in chapter
10. To use the symbol in this way, the caster must hold it
in hand, wear it visibly, or bear it on a shield." }
	end

	def holy_water
		{ :body => "As an action, you can splash the contents
...
requires the caster to expend a 1st-level spell slot" }
	...
	def hunting_trap
		{ :body => "When you use your action to set it,
...
light to dim light in a 5-foot radius." }
	...
	def lock
		{ :body => "A key is provided with the lock. Without the
...
for higher prices." }
	...
	def magnifying_glass
		{ :body => "This lens allows a closer look at
...
small or highly detailed." }
	...
	def manacles
		{ :body => "These metal restraints can bind a Small
...
check. Manacles have 15 hit points." }
	...
	def mess_kit
		{ :body => "This tin box contains a cup and simple
...
shallow bowl." }
	...
	def oil
		{ :body => "Oil usually comes in a clay flask that holds 1
...
can take this damage only once per turn." }
	...
	def poison_basic
		{ :body => "You can use the poison in this vial
...
earlier in this section)." }
	...
	def quiver
		{ :body => "A quiver can hold up to 20 arrows." }
	end

	def ram_portable
		{ :body => "You can use a portable ram to break
...
the ram, giving you advantage on this check." }
	...
	def rations
		{ :body => "Rations consist of dry foods suitable
for extended travel, including jerky, dried fruit,
hardtack, and nuts." }
	end

	def rope
		{ :body => "Rope, whether made of hemp or silk, has 2 hit
points and can be burst with a DC 17 Strength check." }
	end

	def scale_merchant
		{ :body => "A scale includes a small balance,
pans, and a suitable assortment of weights up to 2
pounds. With it, you can measure the exact weight of small objects, such as raw precious metals or trade
goods, to help determine their worth." }
	end

	def spellbook
		{ :body => "Essential for wizards, a spellbook is
a leather-bound tome with 100 blank vellum pages
suitable for recording spells." }
	end

	def spyglass
		{ :body => "Objects viewed through a spyglass are
magnified to twice their size." }
	end

	def tent
		{ :body => "A simple and portable canvas shelter, a
tent sleeps two." }
	end

	def tinderbox
		{ :body => "This small container holds flint, fire steel,

module WeaponsList
	def weapons
      ...
      { :id => 38, :name => "Scimitar", :category => "martial_melee", :cost => 25, :damage => "1d6 slashing", :weight => 3, :properties => "Finnesse, light", :ranged => false },
      { :id => 38, :name => "Shortsword", :category => "martial_melee", :cost => 10, :damage => "1d6 piercing", :weight => 2, :properties => "Finnesse, light", :ranged => false },
      { :id => 38, :name => "Trident", :category => "martial_melee", :cost => 5, :damage => "1d6 piercing", :weight => 4, :properties => "Thrown (range 20/60) versatile (1d8 )", :ranged => false },
      { :id => 38, :name => "War Pick", :category => "martial_melee", :cost => 5, :damage => "1d8 piercing", :weight => 2, :properties => "---", :ranged => false },
      { :id => 38, :name => "Warhammer", :category => "martial_melee", :cost => 15, :damage => "1d8 bludgeoning", :weight => 2, :properties => "Versatile (1d10)", :ranged => false },
      { :id => 38, :name => "Whip", :category => "martial_melee", :cost => 2, :damage => "1d4 slashing", :weight => 3, :properties => "Finnesse, reach", :ranged => false },
      { :id => 38, :name => "Blowgun", :category => "martial_ranged", :cost => 10, :damage => "1 piercing", :weight => 1, :properties => "Ammunition, (range 25/100), loading", :ranged => true },
      { :id => 38, :name => "Crossbow, hand", :category => "martial_ranged", :cost => 75, :damage => "1d6 piercing", :weight => 3, :properties => "Ammunition, (range 30/120), light, loading", :ranged => true },
      { :id => 38, :name => "Crossbow, heavy", :category => "martial_ranged", :cost => 50, :damage => "1d10 piercing", :weight => 18, :properties => "Ammunition, (range 100/400), heavy, loading, two-handed", :ranged => true },
      { :id => 38, :name => "Longbow", :category => "martial_ranged", :cost => 50, :damage => "1d8 piercing", :weight => 2, :properties => "Ammunition, (range 150/600), heavy, two-handed", :ranged => true },

module WeaponsList
	...
	[
  	...
  	{ :id => 14, :name => "Crossbow, light", :category => "simple_ranged", :cost => 25, :damage => "1d8 piercing", :weight => 5, :properties => "Ammunition (range 80/320), loading, two-handed", :ranged => true, :details => [finesse, heavy] },

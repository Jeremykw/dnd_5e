module ArmourList
	def armour
		[
			...
			# :hide => 				{ :category => "medium", :cost => 10, :ac => 12, :dex_mod => true, :dex_mod_max => 2, :stealth => false, :weight => 12 },
			...
			# :breastplate => { :category => "medium", :cost => 400, :ac => 14, :dex_mod => true, :dex_mod_max => 2, :stealth => false, :weight => 20 },			
			# :half_plate => 	{ :category => "medium", :cost => 750, :ac => 15, :dex_mod => true, :dex_mod_max => 2, :stealth => true, :weight => 40, :name => "Half Plate" },
			{ :id => 9, :category => "heavy", :cost => 30, :ac => 14, :dex_mod => false, :dex_mod_max => false, :strength => 13, :stealth => true, :weight => 40, :name => "Ring mail" },
			# :splint => 			{ :category => "heavy", :cost => 200, :ac => 17, :dex_mod => false, :dex_mod_max => false, :strength => 15, :stealth => true, :weight => 60 },
			{ :id => 6, :category => "medium", :cost => 50, :ac => 14, :dex_mod => true, :dex_mod_max => 2, :stealth => true, :weight => 45, :name => "Scale Mail" },
			# :plate => 			{ :category => "heavy", :cost => 1500, :ac => 18, :dex_mod => false, :dex_mod_max => false, :strength => 15, :stealth => true, :weight => 65 },
		]
	end
end
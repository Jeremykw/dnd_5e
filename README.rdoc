...
During development api requests to 'https://dnd5e/api.co' need to be proxied away from the 'localhost://3000'. Using 'https://cors-anywhere.herokuapp.com/' works but can be slow and hit and miss. cloneing the cors-anywhere repo and deploying an individul proxy server seems to work much better:
